...
with open('package.json', 'r+') as f:
    ...
    if ip_address=="localhost":
        ...
        data['scripts']['be-l-ip'] = "python back-end/childify_api/manage.py runserver"
    else:
        data['scripts']['be-ip'] = "back-end\\venv\\Scripts\\activate.bat && python back-end/childify_api/manage.py runserver 0.0.0.0:8000 "
        data['scripts']['be-l-ip'] = "python back-end/childify_api/manage.py runserver 0.0.0.0:8000 "
